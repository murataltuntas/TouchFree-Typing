...
#define NUMBER_COLOR			cv::Scalar(0, 120, 255)	// Sayilarin rengi
...
#define BORDER_COLOR			CV_RGB(0, 120, 255)	    // cizgilerin rengi
#define PROGRESSBAR_COLOR		cv::Scalar(0, 250, 0)	// Progress Bar rengi
#define PROGRESSBAR_COLOR2		cv::Scalar(255, 100, 0)	// Progress Bar rengi
